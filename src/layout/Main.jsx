            ...
            <div className="drawer-side">
                ...
                <div>
                    <ul style={{ backgroundColor: "#282637" }} className="menu h-full">
                        ...
                        <li className='text-xl font-mono font-bold mb-3'><Link to='/inhouse'><LuGamepad2 className='text-2xl' />In-House Games</Link></li>
                        ...
                        <li className='text-xl font-mono font-bold my-5'><Link to='/slots'> <img className='w-7 h-4' src={image2} alt="" /> Slots</Link></li>
                        <li className='text-xl font-mono font-bold mb-5'><Link to='/liveCasino'> <img src={image1} alt="" className='w-6' /> Live Casino</Link></li>
                        <li className='text-xl font-mono font-bold mb-5'><Link to='/favorite'><MdOutlineFavoriteBorder className='text-2xl' />Favorites</Link></li>
                        <li className='text-xl font-mono font-bold mb-5'><Link to='/recent'><BiSolidTimeFive className='text-2xl' />Recent</Link></li>
                        {/* <li className='text-xl font-mono font-bold mb-5'><Link ><TbFlag3 className='text-2xl' />Referral</Link></li> */}
                        <li className='text-xl btn font-mono font-bold mb-5'><Link to='/helpCenter'><AiOutlineQuestionCircle />Help Center<AiFillCaretRight /></Link></li>
